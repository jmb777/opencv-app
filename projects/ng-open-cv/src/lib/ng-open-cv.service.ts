...
export class NgOpenCVService {
  errorOutput: HTMLElement | undefined;
  src = null;
  dstC1 = null;
  dstC3 = null;
  dstC4 = null;
  ...
  onCameraStartedCallback: ((a, b) => void) | undefined;
  ...
  loadImageToCanvas(imageUrl: string, canvasId: string): Observable<any> {
    return new Observable(observer => {
  ...
  addFileInputHandler(fileInputId: string, canvasId: string) {
